...
nameToPlayerConstructor "Negamax" = Just makeNegamaxPlayer -- Extension : Negamax Player 
nameToPlayerConstructor "ReedNegamax" = Just makeReedNegamaxPlayer -- Extension : Reed player with Negamax Player
...
main :: IO ()
main = do {
    putStrLn "What kind of player is player X? (Human/Dumb/Minimax/Reed/Negamax/ReedNegamax)";
    playerX<-getLine;
    putStrLn "What kind of player is player Y? (Human/Dumb/Minimax/Reed/Negamax/ReedNegamax)";
    playerY<-getLine; 
