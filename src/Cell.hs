...
cellsAround c = [ cellTop c , cellLeft c, cellRight c, cellBottom c]

cellsAroundTwo :: Cell -> [Cell]
cellsAroundTwo c = [ cellTop $ cellTop c , cellLeft $ cellLeft c, cellLeft $ cellRight c, cellLeft $ cellBottom c]
{-
    Cells in board. 
...
cellsAroundInBoardTwo :: Cell -> [Cell]
cellsAroundInBoardTwo c = filter cellInBoard (cellsAroundTwo c)
...
-- Extension : Helper function to be used for jumping over player.
isTwoAdjacent :: Cell -> Cell -> Bool 
isTwoAdjacent c c' = distance c c' == 2
